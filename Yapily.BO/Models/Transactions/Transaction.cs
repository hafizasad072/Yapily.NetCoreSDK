...
namespace Yapily.BO.Models
{
    ...
    public class TransactionAmount : AmountBase { }
    ...
    public class DomainCode { public string Code { get; set; } public string Name { get; set; } }
    public class FamilyCode { public string Code { get; set; } public string Name { get; set; } }
    public class SubFamilyCode { public string Code { get; set; } public string Name { get; set; } }
